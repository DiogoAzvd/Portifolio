        ...
        <div id="main">
            ...
            <ProjectBlock
                ...
                list={["Color picker", "Custom slide to change colors", "Range system",
                    ...
                    "Settings to choose witch HSV properties to affect"]}
...
function Block0() {
    return (
        <div id="block0" className="flex">
            ...
            <span className="mediumText">Novice web developer with focus on front end. I use React / Next JS. Check some of my projects!</span>      
        </div>
    );
}
    ...
    return (
        <div className="projectBlock flex" id={customId}>
            <div className="pTextWrap flex">
                <a className="bigText" href={link}>{title}</a>
                <span >{text}</span>
